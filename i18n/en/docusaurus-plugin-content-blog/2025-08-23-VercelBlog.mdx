...
> 后记：可能 `cloudflare` 加速是有一点作用的，但是之前或许由于这个[问题](/docs/Issues#the-issue-of-the-build-folder-being-too-large )，导致效果不太明显。由于后来部署在 Vercel 后已经能够实现流畅[访问](https://www.eurekashadow.xin/ )了，所以就不弄 `cloudflare` 了。
